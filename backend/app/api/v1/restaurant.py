...
def put_storefront_shortcuts(body: ShortcutsIn, restaurant: Restaurant = Depends(current_restaurant_staff), db: Session = StaffDb, _=Depends(STOREFRONT)):
    return storefront.save_shortcuts(db, restaurant, body)
